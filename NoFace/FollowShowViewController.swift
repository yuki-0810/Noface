//
//  FollowShowViewController.swift
//  NoFace
//
...
class FollowShowViewController: UIViewController, UITableViewDelegate, UITableViewDataSource {
    ...
    func handleButton(sender: UIButton, event:UIEvent) {
        ...
        let point = touch!.location(in: self.followTableView)
        let indexPath = followTableView.indexPathForRow(at: point)
    ...
    override func viewDidLoad() {
        ...
        followTableView = UITableView(frame: CGRect(x: 0, y: barHeight, width: displayWidth, height: displayHeight))
        
        // Cell名の登録をおこなう.
        let nib = UINib(nibName: "PostTableViewCell", bundle: nil)
        followTableView.register(nib, forCellReuseIdentifier: "Cell")
        ...
        // テーブルセルのタップを無効にする
        followTableView.allowsSelection = false
    }
